 ...
 * m═══════════════n══════════════════════════n══════════════════o
 *
 * - a: crossingTopStart (╔): The top left corner of the table.
 * - b: horizontalOutsideBorder (═): The horizontal outer border at the top of the table.
 * - c: crossingTopMid (╤): The middle crossing point on the outer top border of the table.
 * - d: crossingTopEnd (╗): The top right corner of the table.
 * - e: verticalOutsideBorder (║): The vertical outer border of the table.
 * - f: verticalInsideBorder (│): The vertical inner border of the table.
 * - g: crossingHeadStartBottom (╠): The left corner of the border between the header and the body.
 * - g: horizontalOutsideBorder (═): The horizontal outer border between the header and the body.
 * - h: crossingHeadMidBottom (╪): The middle crossing point on the outer border between the header and the body.
 * - i: crossingHeadEndBottom (╣): The right corner of the border between the header and the body.
 * - j: crossingMidStart (├): The left corner of the border between two rows.
 * - k: crossing (┼): The middle crossing point on the inner border between two rows.
 * - l: crossingMidEnd (┤): The right corner of the border between two rows.
 * - m: crossingBottomStart (╚): The left corner of the outer border at the bottom of the table.
 * - n: crossingBottomMid (╧): The middle crossing point on the outer bottom border of the table.
 * - o: crossingBottomEnd (╝): The right corner of the outer border at the bottom of the table.
 */
type TableTheme = {
  crossing: string;
