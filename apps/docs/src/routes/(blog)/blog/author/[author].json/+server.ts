import { authorNameToSlug, slugToAuthorName, getAuthorWithGravatar } from "$lib/content/author.js";
...
type AuthorPostsResponse = {
  type: "author-posts";
  author: { name: string; slug: string; email?: string; gravatarUrl?: string };
  posts: BlogPostSummary[];
  total: number;
  links: { html: string; json: string; authorListing: string };
};
