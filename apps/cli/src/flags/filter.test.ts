...
import { filterFactory } from "./filter.ts";
...
describe("filter flag", () => {
  ...
  it("should handles alternative operator syntaxes", async () => {
    ...
    const {
      flags: { filter: result2 },
    } = await Parser.parse(["--filter", "age=gt25"], {
      flags: {
        filter: filterFactory()(),
      },
    });
    ...
    const {
      flags: { filter: result3 },
    } = await Parser.parse(["--filter", "age=gte25"], {
      flags: {
        filter: filterFactory()(),
      },
    });
    ...
    const {
      flags: { filter: result4 },
    } = await Parser.parse(["--filter", "age=lt25"], {
      flags: {
        filter: filterFactory()(),
      },
    });
    ...
    const {
      flags: { filter: result5 },
    } = await Parser.parse(["--filter", "age=lte25"], {
      flags: {
        filter: filterFactory()(),
      },
    });
    ...
    const {
      flags: { filter: result6 },
    } = await Parser.parse(["--filter", "age=ne25"], {
      flags: {
        filter: filterFactory()(),
      },
    });
    ...
    } = await Parser.parse(["--filter", "name=likeJohn"], {
      flags: {
        filter: filterFactory()(),
      },
    });
