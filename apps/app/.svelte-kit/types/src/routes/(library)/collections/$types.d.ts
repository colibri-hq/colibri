...
type RouteParams = {  };
type RouteId = '/(library)/collections';
...
type LayoutRouteId = RouteId | "/(library)/collections" | "/(library)/collections/[collection]"
type LayoutParams = RouteParams & { collection?: string }
