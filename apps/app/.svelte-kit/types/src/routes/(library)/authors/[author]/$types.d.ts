...
type RouteId = '/(library)/authors/[author]';
...
export type PageServerData = Expand<OptionalUnion<EnsureDefined<Kit.LoadProperties<Awaited<ReturnType<typeof import('../../../../../../../src/routes/(library)/authors/[author]/+page.server.js').load>>>>>>;
