...
type LayoutRouteId = RouteId | "/(library)/books" | "/(library)/books/[book=id]/cover" | "/(library)/books/[book=id]/edit" | "/(library)/books/add"
type LayoutParams = RouteParams & { book?: MatcherParam<typeof import('../../../../../../src/params/id.js').match> }
