...
type RouteParams = { catalog: MatcherParam<typeof import('../../../../../../../src/params/id.js').match> };
type RouteId = '/(library)/discover/[catalog=id]';
...
export type PageServerData = Expand<OptionalUnion<EnsureDefined<Kit.LoadProperties<Awaited<ReturnType<typeof import('../../../../../../../src/routes/(library)/discover/[catalog=id]/+page.server.js').load>>>>>>;
