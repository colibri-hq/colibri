...
type RouteParams = { publisher: string };
type RouteId = '/(library)/publishers/[publisher]';
...
export type PageData = Expand<Omit<PageParentData, keyof Kit.LoadProperties<Awaited<ReturnType<typeof import('../../../../../../../src/routes/(library)/publishers/[publisher]/+page.js').load>>>> & OptionalUnion<EnsureDefined<Kit.LoadProperties<Awaited<ReturnType<typeof import('../../../../../../../src/routes/(library)/publishers/[publisher]/+page.js').load>>>>>>;
