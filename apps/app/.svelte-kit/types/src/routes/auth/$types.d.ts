...
type LayoutRouteId = RouteId | "/auth/attestation" | "/auth/login" | "/auth/login/unknown" | "/auth/oauth/authorize" | "/auth/oauth/device"
...
export type LayoutServerData = Expand<OptionalUnion<EnsureDefined<Kit.LoadProperties<Awaited<ReturnType<typeof import('../../../../../src/routes/auth/+layout.server.js').load>>>>>>;
