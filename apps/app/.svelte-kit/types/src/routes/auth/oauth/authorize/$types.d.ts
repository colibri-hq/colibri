...
type RouteParams = {  };
type RouteId = '/auth/oauth/authorize';
...
export type PageServerData = Expand<OptionalUnion<EnsureDefined<Kit.LoadProperties<Awaited<ReturnType<typeof import('../../../../../../../src/routes/auth/oauth/authorize/+page.server.js').load>>>>>>;
