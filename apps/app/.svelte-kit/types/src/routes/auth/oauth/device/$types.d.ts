...
type RouteParams = {  };
type RouteId = '/auth/oauth/device';
...
type ActionsExport = typeof import('../../../../../../../src/routes/auth/oauth/device/+page.server.js').actions
...
export type PageData = Expand<Omit<PageParentData, keyof Kit.LoadProperties<Awaited<ReturnType<typeof import('../../../../../../../src/routes/auth/oauth/device/+page.js').load>>>> & OptionalUnion<EnsureDefined<Kit.LoadProperties<Awaited<ReturnType<typeof import('../../../../../../../src/routes/auth/oauth/device/+page.js').load>>>>>>;
