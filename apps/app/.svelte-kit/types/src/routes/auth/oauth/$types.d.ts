...
type LayoutRouteId = RouteId | "/auth/oauth/authorize" | "/auth/oauth/device"
...
export type LayoutServerData = Expand<OptionalUnion<EnsureDefined<Kit.LoadProperties<Awaited<ReturnType<typeof import('../../../../../../src/routes/auth/oauth/+layout.server.js').load>>>>>>;
